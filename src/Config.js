module.exports = (NodeGit, { constants }) => {
  ...
  class Config {
     ...
     * @returns {object} An object of git flow config key/value pairs.
     */
     ...
     * @returns {Array} A list of config keys
     */
     ...
     * @returns {number | string}  An error message, or 0 if all required keys are present.
     */
     ...
     * @returns {string}   The config value of the git flow master branch
     */
     ...
     * @async
     * @param {Repository}  repo  The nodegit repository to get the config value from
     * @returns {string}   The config value of the git flow develop branch
     */
     ...
     * @async
     * @param {Repository}  repo  The nodegit repository to get the config value from
     * @returns {string}   The config value of the git flow feature prefix
     */
     ...
     * @async
     * @param {Repository}  repo  The nodegit repository to get the config value from
     * @returns {string}   The config value of the git flow release prefix
     */
     ...
     * @async
     * @param {Repository}  repo  The nodegit repository to get the config value from
     * @returns {string}   The config value of the git flow hotfix prefix
     */
     ...
     * @async
     * @param {Repository}  repo  The nodegit repository to get the config value from
     * @returns {string}   The config value of the git flow version tag prefix
     */
